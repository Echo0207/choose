...
class Roulette:
    def __init__(self, category):
        ...
        self.initial_rotations = 100  # 轉盤的啟動旋轉次數
        self.options = self.read_choices(category)
        self.rotation_speed = 8  # 每幀旋轉的角度
    ...
    def run_roulette(self):
        ...
        # 計算轉盤應旋轉的目標角度，以便被選中的選項停在指針的下方
        target_angle = 270 - (selected_index * (360 / len(self.options)) + (360 / (2 * len(self.options))))  # 270是因為指針在90度
        target_angle %= 360
